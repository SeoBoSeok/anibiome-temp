...
<div class="wrap">
    ...
    <div class="content_wrap sub veterinary">
		<section class="sub_visual">
			...
			<div class="page_navi box_width">
				...
				<div class="dropdown_set">
					...
					<div class="dropdown">
						<div class="dropbtn open-btn-ckver" >전문진료자문시스템</div>
						<div class="dropdown-content">
							<a href="">수의통합의학</a>
							<a href="">강의/교육컨텐츠</a>
        ...
        <section class="eldercare" style="display: none;">
            <div class="section_padding box_width eldercare-wrap any_move_item">
                <div class="item012">
					<img src="/assets/images/elder_care_anim.png">
				</div>
                <img src="/assets/images/elder_care_main_notitle.svg" alt="elder_care_notitle">
            </div>
        </section>
...
<div class="box_width">
    ...
    ?>
    <a href="<?php echo $list[$i]['href'] ?>" class="anibiome_contents_link">
        <div class="anibiome_contents_list">
            <div class="anibiome_contents_author">
                <?php echo $list[$i]['name'] ?> <?php echo $list[$i]['datetime'] ?>
            </div>
            <div class="anibiome_contents_subject">
    ...
    <div class="anibiome_contents_footer">
        <!-- 페이지 -->
